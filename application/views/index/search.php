                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single_place">
                            ...
                            <div class="place_info">
                                <a href="<?= HOST_NAME.'index/memorial/'.$memorial->id ?>"><h3><?= $memorial->firstName.' '.$memorial->lastName ?></h3></a>
                                ...
                                <div class="rating_days d-flex justify-content-between">
                                    <span class="text-muted">(<?= $memorial->views ?> View<?php echo $memorial->views > 1 ? 's' : ''; ?>)</span>
                                    <div class="days">
